...
if __name__ == "__main__":
    ...
    MODELDIR    = 'data/models/kaldi-nnet3-voxforge-de-r20171016'
    # MODELS      = [ 'lstm_ld5', 'nnet_tdnn_a' ]
    MODELS      = [ 'nnet_tdnn_a' ]
    WAVFILES    = [ 'data/2015-01-27-12-32-58_Kinect-Beam.wav', 'data/2015-01-27-12-34-36_Kinect-Beam.wav', 'data/2015-01-27-12-34-46_Kinect-Beam.wav']
