...
def save_audio(wav_file):
	...
	device = find_device(p, ["default"]) #"pulse","input", "mic", "audio", "default"
...
if __name__ == '__main__':
		text = input("How many seconds to recognize?")
		RECORD_SECONDS = int(text)
		...
		while(True):
				...
				if(text=='y'):
						save_audio(WAVE_OUTPUT_FILENAME_16)
