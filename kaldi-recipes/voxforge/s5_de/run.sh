...
echo "Prepare ARPA LM and vocabulary using SRILM"
local/voxforge_prepare_lm.sh --order ${lm_order} || exit 1

# Prepare the lexicon and various phone lists
# Pronunciations for OOV words are obtained using a pre-trained Sequitur model
echo "Prepare the lexicon and various phone lists"
echo "Pronunciations for OOV words are obtained using a pre-trained Sequitur model"
